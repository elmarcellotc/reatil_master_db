...
-- Core tables
SOURCE /init-db/01_core_tables/01_SKU.sql;
...
-- Infrastructure
SOURCE /init-db/02_infrastructure/01_stores.sql;
SOURCE /init-db/02_infrastructure/02_warehouses.sql;
...
SOURCE /init-db/06_event_registry/05_store_acquisitions_sku.sql;